...
<br/><br/>
<div class="res_zf" style="margin-bottom:500px;">
<p><?=getMessage('DOROGIYE_DRUZIYA');?><br/>
<?=getMessage('SPSIBO_ZRM');?> <?=$title_m?>".<br/>
<!--
...
-->
<br/><br/>
	<a href="<?=$dir_event?>step_1.php"><img src="/images/registration_event/button_gfg.png"></a>
<br/><br/>
<div class="chte"> <span onclick="f_ps('txt1')"><img src="/images/registration_event/button_opros.png"></span><div id="txt1" class="txt">
<div align="right"><i><span id="fr_1" onclick="f_fr(1)" style="display:none;"><?=getMessage('OPROS');?></span> &nbsp;&nbsp;&nbsp; <span id="fr_2" onclick="f_fr(0)"><?=getMessage('RESULTS');?></span></i></div>
<div class="fo_opros">
 <?
 $FORM_ID = 3;
...
$arFields = array();
	...
	$form_reg=$arAnswer['form_reg'][0]['ANSWER_VALUE'];
		switch($form_reg) {
		case "form_reg_op":$vopros_1_1++;break;
		case "form_reg_p":$vopros_1_2++;break;
		case "form_reg_nop":$vopros_1_3++;break;
		case "form_reg_np":$vopros_1_4++;break;
		}
		
	$udobno=$arAnswer['udobno'][0]['ANSWER_VALUE'];
		switch($udobno) {
		case "udobno_op":$vopros_2_1++;break;
		case "udobno_p":$vopros_2_2++;break;
		case "udobno_nop":$vopros_2_3++;break;
		case "udobno_np":$vopros_2_4++;break;
		}
	$design=$arAnswer['design'][0]['ANSWER_VALUE'];
		switch($design) {
		case "design_op":$vopros_3_1++;break;
		case "design_p":$vopros_3_2++;break;
		case "design_nop":$vopros_3_3++;break;
		case "design_np":$vopros_3_4++;break;
		}
	$vv++;
	}
...
<table>
<tr><th colspan="2" align="right"><?=getMessage('COL_RES');?> &nbsp;&nbsp;&nbsp;</th><th><?=$vv?></th></tr>
<tr class="tr_t"><th colspan="3">Насколько Вам понравилась форма регистрации<?=(LANGUAGE_ID!="ru")?"<br /><span style='font-size:80%'>(".getMessage('VOP_1').")</span>":"";?></th></tr>
<tr><th align="left">Очень понравилась<?=(LANGUAGE_ID!="ru")?"<br /><span style='font-size:80%'>(".getMessage('OTV_1_1').")</span>":"";?></th><td width="300"><div class="o1"  style="width:<?=(3*$ro_1_1)?>px;">&nbsp;</div></td><td><?=$vopros_1_1?>(<?=$ro_1_1?>%)</td></tr>
<tr><th align="left">Понравилась<?=(LANGUAGE_ID!="ru")?"<br /><span style='font-size:80%'>(".getMessage('OTV_1_2').")</span>":"";?></th><td><div class="o2"  style="width:<?=(3*$ro_1_2)?>px;">&nbsp;</div></td><td><?=$vopros_1_2?>(<?=$ro_1_2?>%)</td></tr>
<tr><th align="left">Не очень понравилась<?=(LANGUAGE_ID!="ru")?"<br /><span style='font-size:80%'>(".getMessage('OTV_1_3').")</span>":"";?></th><td><div class="o3"  style="width:<?=(3*$ro_1_3)?>px;">&nbsp;</div></td><td><?=$vopros_1_3?>(<?=$ro_1_3?>%)</td></tr>
<tr><th align="left"><?=getMessage('OTV_1_1');?>Не понравилась<?=(LANGUAGE_ID!="ru")?"<br /><span style='font-size:80%'>(".getMessage('OTV_1_4').")</span>":"";?></th><td><div class="o4"  style="width:<?=(3*$ro_1_4)?>px;">&nbsp;</div></td><td><?=$vopros_1_4?>(<?=$ro_1_4?>%)</td></tr>

<tr class="tr_t"><th colspan="3">Насколько Вам было удобно заполнять<?=(LANGUAGE_ID!="ru")?"<br /><span style='font-size:80%'>(".getMessage('VOP_3').")</span>":"";?></th></tr>
<tr><th align="left">Очень удобно<?=(LANGUAGE_ID!="ru")?"<br /><span style='font-size:80%'>(".getMessage('OTV_2_1').")</span>":"";?></th><td width="300"><div class="o1"  style="width:<?=(3*$ro_2_1)?>px;">&nbsp;</div></td><td><?=$vopros_2_1?>(<?=$ro_2_1?>%)</td></tr>
<tr><th align="left">Удобно<?=(LANGUAGE_ID!="ru")?"<br /><span style='font-size:80%'>(".getMessage('OTV_2_2').")</span>":"";?></th><td><div class="o2"  style="width:<?=(3*$ro_2_2)?>px;">&nbsp;</div></td><td><?=$vopros_2_2?>(<?=$ro_2_2?>%)</td></tr>
<tr><th align="left">Не очень удобно<?=(LANGUAGE_ID!="ru")?"<br /><span style='font-size:80%'>(".getMessage('OTV_2_3').")</span>":"";?><?=(LANGUAGE_ID!="ru")?"<br /><span style='font-size:80%'>(".getMessage('VOP_1').")</span>":"";?></th><td><div class="o3"  style="width:<?=(3*$ro_2_3)?>px;">&nbsp;</div></td><td><?=$vopros_2_3?>(<?=$ro_2_3?>%)</td></tr>
<tr><th align="left">Не удобно<?=(LANGUAGE_ID!="ru")?"<br /><span style='font-size:80%'>(".getMessage('OTV_2_4').")</span>":"";?></th><td><div class="o4"  style="width:<?=(3*$ro_2_4)?>px;">&nbsp;</div></td><td><?=$vopros_2_4?>(<?=$ro_2_4?>%)</td></tr>

<tr class="tr_t"><th colspan="3">Насколько Вам понравился дизайн формы<?=(LANGUAGE_ID!="ru")?"<br /><span style='font-size:80%'>(".getMessage('VOP_13').")</span>":"";?></th></tr>
<tr><th align="left">Очень понравился<?=(LANGUAGE_ID!="ru")?"<br /><span style='font-size:80%'>(".getMessage('OTV_3_1').")</span>":"";?></th><td width="300"><div class="o1"  style="width:<?=(3*$ro_3_1)?>px;">&nbsp;</div></td><td><?=$vopros_3_1?>(<?=$ro_3_1?>%)</td></tr>
<tr><th align="left">Понравился<?=(LANGUAGE_ID!="ru")?"<br /><span style='font-size:80%'>(".getMessage('OTV_3_2').")</span>":"";?></th><td><div class="o2"  style="width:<?=(3*$ro_3_2)?>px;">&nbsp;</div></td><td><?=$vopros_3_2?>(<?=$ro_3_2?>%)</td></tr>
<tr><th align="left">Не очень понравился<?=(LANGUAGE_ID!="ru")?"<br /><span style='font-size:80%'>(".getMessage('OTV_3_3').")</span>":"";?></th><td><div class="o3"  style="width:<?=(3*$ro_3_3)?>px;">&nbsp;</div></td><td><?=$vopros_3_3?>(<?=$ro_3_3?>%)</td></tr>
<tr><th align="left">Не понравился<?=(LANGUAGE_ID!="ru")?"<br /><span style='font-size:80%'>(".getMessage('OTV_3_4').")</span>":"";?></th><td><div class="o4"  style="width:<?=(3*$ro_3_4)?>px;">&nbsp;</div></td><td><?=$vopros_3_4?>(<?=$ro_3_4?>%)</td></tr>
</table>
</div>
<br/>
<u><span onclick="f_us('txt1')" style="cursor:pointer;"><?=getMessage('CLOSE');?></span></u></div></div>
<br/><br/>
<h2><?$APPLICATION->ShowTitle();?></h2>
<?$APPLICATION->IncludeComponent("bitrix:form.result.list.my", "result_list_".$code_m,
 array(
	"FORMS" => array(
		0 => $form_m,
