...
$(document).ready(function(){
	...
	$(".box_copy input:submit").click(function(){$(".box_copy").fadeOut(500);$(".box_indicator").fadeIn(500);});
	
	$(".res_edit a").click(function(){$(".box_indicator").fadeIn(500);});
	$("#a_print").click(function(){$(".box_indicator").fadeIn(500);});
...
var tqs=$("#tqs").val();
  $.ajax({ 
				...
				data: "tqs="+tqs+"&form_id="+form_id+"&answer_id="+answer_id+"&sts="+sts+"&url_edit="+url_edit,  
                cache: false,  
