...
if(CModule::IncludeModule("form")){ 
	...
	$ar_Answer = CFormResult::GetDataByID(
		$RESULT_ID, 
		array('name','family','email','email_2','em_bd','history_status','lang_id','code_m'),  // массив символьных кодов необходимых вопросов
		$ar_Result, 
		$ar_Answer2);  
...
if($CURRENT_STATUS_ID <>$PREV_STATUS_ID) {
	...
	@include $_SERVER["DOCUMENT_ROOT"]."/com/registration_event/".$code_m."/mail_status/lang/".$lang_id."/status_del.php"; //шаблон письма на языке регистрации заявки
