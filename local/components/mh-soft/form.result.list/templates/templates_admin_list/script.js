//Проверка подключения jQuery
	...
	//if (!window.jQuery) alert("Для корректной работы компонента необходимо \nподключить библиотеку jQuery");
...
$(document).ready(function(){
	...
	$(".inf_copy_result").delay(3000).fadeOut(200);
	...
	$(".box_del #close").click(function(){$(".box_del").fadeOut(500);});
	$(".box_del .but_reset_del").click(function(){$(".box_del").fadeOut(500);});
	$(".box_del input:submit").click(function(){$(".box_del").fadeOut(500);$(".box_indicator").fadeIn(100);});
