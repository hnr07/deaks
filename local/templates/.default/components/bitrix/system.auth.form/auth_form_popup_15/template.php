...
<input type="hidden" id="site_lang" value="<?=$_lang?>">
<?
...
<?endif?>
		<tr>
			<td colspan="2"><input type="submit" name="Login" value="Кнопка 1 <?=GetMessage("AUTH_LOGIN_BUTTON")?>" /></td>
		</tr>
...
<?endif?>
		<tr>
			<td colspan="2"><input type="submit" name="Login" value="Кнопка 2 <?=GetMessage("AUTH_LOGIN_BUTTON")?>" /></td>
		</tr>
		<tr>
