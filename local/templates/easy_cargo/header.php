...
<script type="text/javascript" src="<?=SITE_TEMPLATE_PATH?>/js/datetimepicker/jquery.datetimepicker.full.js"></script>
    ...
    <script type="text/javascript">
		...
		var bw=$(window).width();
			...
			*/
			...
			$(".capcha_box").on("click", ".div_capcha #new_capcha", function(){
				...
				var s_url="/shipment/orders/new_capcha.php";
				$.ajax({  
					type: "POST",
					url: s_url,  
					data: "", 
		...
		function go_pay(order_id) {
			$.ajax({  
				type: "POST",
				url: "/shipment/orders/payment/index.php",  
		...
		<div class="row-3">
			<div class="box_call-center">
				...
				<div class="call-form b_shadow">
					<?$APPLICATION->IncludeComponent("bitrix:main.include", "", array("AREA_FILE_SHOW" => "file", "PATH" => "/shipment/orders/call_me.php"), false);?>
				</div>
			</div>
