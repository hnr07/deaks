...
<body style="font-size:9pt;margin: 0pt; padding: 0pt; background: <?=$background; ?>"<? if ($_REQUEST['PRINT'] == 'Y') { ?> onload="setTimeout(window.print, 0);"<? } ?>>
<div class="pay_bill_dls" style="margin: 0pt; padding: <?=join('pt ', $margin); ?>pt; width: <?=$width; ?>pt; font-family:arial;">

<table class="header" width="100%" style="font-size:9pt;">
	<tr>
	<td>
		...
		<td style="padding-right: 5pt; padding-bottom: 5pt; text-align:right;">
...
------------------------------- -->
<table class="acc" style="font-size:9pt;">
<colgroup>
		<col width="6%">
		<col width="24%">
		<col width="6%">
	...
	<tr valign="top">
		<td colspan="4" rowspan="2"><?=$sellerBank; ?><br /><br /><?=Loc::getMessage('SALE_HPS_BILL_SELLER_BANK_NAME')?></td><td><?=Loc::getMessage('SALE_HPS_BILL_SELLER_BANK_BIK')?></td><td colspan="3"><?=$params["SELLER_COMPANY_BANK_BIC"]; ?></td>
	</tr>
	<tr valign="top">
		<td><nobr><?=Loc::getMessage('SALE_HPS_BILL_SELLER_ACC_CORR')?></nobr></td><td colspan="3"><?=$params["SELLER_COMPANY_BANK_ACCOUNT_CORR"]; ?></td>
	</tr>
	<tr valign="top">
		<td><?=Loc::getMessage('INN')?></td><td><?=$params["SELLER_COMPANY_INN"]?></td><td><?=Loc::getMessage('KPP')?></td><td><?=$params["SELLER_COMPANY_KPP"]?></td><td><nobr><?=Loc::getMessage("SALE_HPS_BILL_SELLER_ACC"); ?></nobr></td><td colspan="3"><?=$sellerRs; ?></td>
	</tr>
	<tr valign="top">
		<td colspan="4" rowspan="3"><?=$params["SELLER_COMPANY_NAME"]; ?><br /><br /><?=Loc::getMessage('SALE_HPS_BILL_SELLER_NAME')?></td><td><nobr>Вид оп.</nobr></td><td>01</td><td>Срок плат.</td><td> </td>
	</tr>
	<tr valign="top">
		<td><nobr>Наз. пл.</nobr></td><td></td><td><nobr>Очер. плат.</nobr></td><td>5</td>
	</tr>
	<tr valign="top">
		<td>Код</td><td>СЧ160700000008090003</td><td>Рез. поле</td><td></td>
	</tr>
	
	<tr valign="top">
		<td colspan="8">Оплата по заказу клиента № <?=$params["ACCOUNT_NUMBER"]?></td>
	</tr>
	<tr valign="top">
		<td colspan="8">Назначение платежа</td>
	</tr>
</table>
<br>
<br>
...
<br>
Поставщик: ООО "Диагональ", ИНН 7841493212, КПП 784101001, Россия,191186, г.Санкт-Петербург, ул.Итальянская, д15, лит, А, пом. 3Н, тел.: (925) 221-09-99
<br><br>
<?
...
if ($params["BUYER_PERSON_COMPANY_NAME"]) {
	...
	echo sprintf(", %s", Loc::getMessage('SALE_HPS_BILL_SELLER_COMPANY_PHONE', array('#PHONE#' => $params["BUYER_PERSON_COMPANY_PHONE"])));
...
<table class="it" width="100%" style="font-size:9pt;">
	<tr>
...
<div style="position: relative; "><?=CFile::ShowImage(
	...
	160, 160,
	'style="position: absolute; left: 80pt; "'
); ?></div>
<? } ?>

<div style="position: relative">
	<table class="sign" style="font-size:9pt;">
