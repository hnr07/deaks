...
<?endif?>
		...
		<div class="bx-authform-formgroup-container">
			...
			<div class="bx-authform-input-container">
				<input type="text" name="USER_NAME" maxlength="255" value="<?=$arResult["USER_NAME"]?>" placeholder="<?=GetMessage("AUTH_NAME")?>" />
			</div>
		</div>
		...
		<div class="bx-authform-formgroup-container">
			...
			<div class="bx-authform-input-container">
				<input type="text" name="USER_LAST_NAME" maxlength="255" value="<?=$arResult["USER_LAST_NAME"]?>" placeholder="<?=GetMessage("AUTH_LAST_NAME")?>" />
			</div>
		</div>

		<div class="bx-authform-formgroup-container">
			<!--<div class="bx-authform-label-container"><span class="bx-authform-starrequired">*</span><?=GetMessage("AUTH_LOGIN_MIN")?></div>-->
			<div class="bx-authform-input-container"><span class="authform-starrequired">*</span>
				<input type="text" name="USER_LOGIN" maxlength="255" value="<?=$arResult["USER_LOGIN"]?>" placeholder="<?=GetMessage("AUTH_LOGIN_MIN")?>" />
			</div>
		</div>
...
<?endif?>
		...
		<div class="bx-authform-formgroup-container">
			...
			<div class="bx-authform-input-container"><span class="authform-starrequired">*</span>
				<input type="text" name="USER_EMAIL" maxlength="255" value="<?=$arResult["USER_EMAIL"]?>" placeholder="<?=GetMessage("AUTH_EMAIL")?>" />
			</div>
		</div>
...
<?if ($arResult["USE_CAPTCHA"] == "Y"):?>
		...
		<div class="bx-authform-formgroup-container">
			...
			<div class="bx-authform-input-container"><span class="authform-starrequired">*</span>
				<input type="text" name="captcha_word" maxlength="50" value="" autocomplete="off" placeholder="<?=GetMessage("CAPTCHA_REGF_PROMT")?>"/>
			</div>
		</div>
...
<?endif?>
		...
		<div class="bx-authform-description-container">
			<span style="color:red;">*</span> <?=GetMessage("AUTH_REQ")?>
		</div>
