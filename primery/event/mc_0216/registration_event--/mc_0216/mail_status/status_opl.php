...
if($CURRENT_STATUS_ID <>$PREV_STATUS_ID) {
	...
	@include $_SERVER["DOCUMENT_ROOT"]."/com/registration_event/".$code_m."/mail_status/lang/".$lang_id."/status_opl.php"; //шаблон письма на языке регистрации заявки
