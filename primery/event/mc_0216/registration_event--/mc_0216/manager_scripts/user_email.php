...
$ar_pole=array('status','kem_priglashen_chk','kem_priglashen_name','kem_priglashen_family','chk','name','family','middle_name','email','email_2','tel','skype','sex','country','city','birthday','prioritet','p_name','p_family','p_date','p_due_date','p_viza','p_fly','fly_1','fly_2','p_hotel','day_hotel_start','day_hotel_finish','hotel','nomer','p_transfer','d_konf','d_ujin','d_futbolka','money_2','currency','sum_debt','billingdate','claimdate','t_money_2','em_bd','oplata','venue');
...
unlink($addres);
	...
	if(!$npp) echo "<tr><td colspan='8'> Нет заявок для обработки. Измените параметры фильтра.</td></tr>";
		...
		if (fwrite($fr, $somecontent) === FALSE) {
			...
			?>
			<div class="chte"><b>Файл создан!</b> <span onclick="f_ps('txt7')"><u>Скачать >>></u></span><div id="txt7" class="txt">
Для скачивания файла кликните правой кнопкой мыши по имени файла, веберите пункт "Сохранить объект как". Сохранённый файл открыть с помощью Exel. В дальнейшем файл можно сохранить в формате Exel <div style="text-align:center"><a href='address_list.xml' target="_blank" style="font-size:14pt;">address_list.xml</a></div>
