	...
	if($user_id) {
		...
		//echo "<pre>";print_r($f_arRes);echo "</pre>";
			...
			$ar_Answer = CFormResult::GetDataByID(
				$res['ID'],
				array('family','name','sum_debt','email','tel','country'), 
				$ar_Result, 
				$ar_Answer2);
				...
				$country=$ar_Answer['country'][0]['USER_TEXT'];
				$tel=$ar_Answer['tel'][0]['USER_TEXT'];
				$email=$ar_Answer['email'][0]['USER_TEXT'];
				...
				$ar_ri[$user_login][$code_m][$ar_code[$i]][$res['ID']]['country']=$country;
				$ar_ri[$user_login][$code_m][$ar_code[$i]][$res['ID']]['tel']=$tel;
				$ar_ri[$user_login][$code_m][$ar_code[$i]][$res['ID']]['email']=$email;
...
$shit = array("&lt;p&gt;", "&lt;\/p&gt;", "&lt;", "&gt;", "\\r\\n", "&lt;b&gt;", "&lt;\/b&gt;", "<b>", "</b>");
$good = array("", "", "", "", "", "", "", "", "");
$new = trim(str_replace($shit, $good, $str));
//$new = str_replace("[", "", $new);
//$new = str_replace("]", "", $new);
//$new = $str;
